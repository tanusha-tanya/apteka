    ...
    <div class="user">
        <div class="container">
            ...
            <div class="user-block">
                ...
                <user-tab form-name="itn" title="ИНН организации" :mask="masks.inn" :opened="false" :state="itn"/>
                <user-tab form-name="company_name" title="Название организации" :opened="false" :state="company_name"/>
