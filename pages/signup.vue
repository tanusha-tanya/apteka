  ...
  <div class="registration">
    ...
    <form action="#" class="registration__form" @submit.prevent="submitHandler">
      ...
      <FormInput
        ...
        @getData="getInputData"
        type="text"
        :has_error="!!(errorMsg.accountable_full_name)"
        :error_message="!!(errorMsg.accountable_full_name) ? errorMsg.accountable_full_name[0] : ''"
        :error_class="!!(errorMsg.accountable_full_name) ? 'invalid' : ''"
      />
      <FormInput
        label="Телефон"
        form_name="phone"
        ...
        type="text"
        :is_required="false"
        :has_error="errorMsg.phone"
        :error_message="!!(errorMsg.phone) ? errorMsg.phone[0] : ''"
        :error_class="!!(errorMsg.phone) ? 'invalid' : ''"
      />
      <FormInput
        label="Веб-сайт"
        form_name="website"
        ...
        :is_required="false"
        :has_error="!!(errorMsg.website) "
        :error_message="!!(errorMsg.website) ? errorMsg.website[0] : ''"
        :error_class="!!(errorMsg.website)  ? 'invalid' : ''"
      />
...
<script>
    ...
    import {checkINN} from "../helpers/validation";
